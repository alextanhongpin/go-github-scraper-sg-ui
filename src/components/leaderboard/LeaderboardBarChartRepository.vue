...
export default class LeaderboardBarChartRepository extends Vue {
  ...
  @Prop({ default:  'Total repositories found in Malaysia and Singapore' }) private subheader: string;

  @State('leaderboardRepositoryByYears', Namespace.repo) items?: Leaderboard[];
  @Action('fetchRepositoriesByYears', Namespace.repo) fetchRepositoryCountByYears: any
  mounted () {
